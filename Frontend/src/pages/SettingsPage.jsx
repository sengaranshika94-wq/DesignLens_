          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <Input defaultValue="Jordan Doe" />
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-medium text-foreground">
                  Email
                </label>
                <Input type="email" defaultValue="jordan@designlens.app" />
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {notificationSettings.map((setting) => (
              <ToggleRow key={setting.key} {...setting} />
            ))}
          </CardContent>
        </Card>
      </div>
...
const notificationSettings = [
  {
    ...
    description: 'Get notified when an analysis finishes processing.',
    defaultOn: true,
  },
  {
    key: 'weekly-summary',
    title: 'Weekly Summary',
    description: 'Receive a weekly summary of your design scores.',
    defaultOn: true,
  },
  {
    key: 'product-updates',
...
function ToggleRow({ title, description, defaultOn }) {
  return (
