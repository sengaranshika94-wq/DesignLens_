...
/**
 * WebsitePreview — renders a fake "website screenshot" inside a browser frame,
 * with optional animated analysis markers overlaid.
 */
export default function WebsitePreview({
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setScanComplete(true), 1200);
      ...
      <div className="flex items-center gap-2 border-b border-border bg-secondary/50 px-4 py-2.5">
        ...
        <div className="ml-2 flex-1">
          <div className="flex h-6 items-center gap-1.5 rounded-md bg-background px-2.5 text-[10px] text-muted-foreground">
            ...
            <span className="truncate font-mono">portfolio.studio</span>
          </div>
        </div>
      </div>
                ...
                >
                  <div className="group flex items-center gap-0">
                    <div
                      ...
                      style={{ borderColor: m.color, boxShadow: `0 0 0 4px ${m.color}30` }}
                    />
                    <div
                      className={cn(
                        'absolute whitespace-nowrap rounded-md px-2 py-1 text-[10px] font-medium shadow-md',
                        'left-4 top-4'
                      )}
                      style={{
